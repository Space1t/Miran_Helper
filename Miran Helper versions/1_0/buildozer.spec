...
title = Помощник MIRAN

# (str) Package name
package.name = MIRAN_helper

# (str) Package domain (needed for android/ios packaging)
package.domain = org.Miran
...
requirements = python3, kivy, kivy_reloader, android, tomlkit, git+https://github.com/kivy-school/trio.git, attrs, outcome, sniffio, sortedcontainers, exceptiongroup
